...
import { updateListing } from "../Redux/Listing/listingApi";
...
const UpdateListing = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const data = await updateListing(params.listingId, formData);
  ...
  useEffect(() => {
    const fetchListing = async () => {
      try {
        const { data } = await axios.patch(`/api/listing/${params.listingId}`);
